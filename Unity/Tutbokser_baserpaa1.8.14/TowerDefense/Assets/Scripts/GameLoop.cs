...
public class GameLoop : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (player1.GetComponent<PlayerScript>().unitList.Count <= 0 && player1.GetComponent<PlayerScript>().recruitmentController.GetComponent<RecruitmentScript>().backlogIsEmpty && aiPlayer.GetComponent<PlayerScript>().unitList.Count <= 0 && aiPlayer.GetComponent<PlayerScript>().aiBacklog.Count <= 0 && roundActive)
        {
    ...
    public bool decrementCash(GameObject player, int deincrement)
    {
