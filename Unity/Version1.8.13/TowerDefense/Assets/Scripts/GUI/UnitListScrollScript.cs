...
public class UnitListScrollScript : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        if (textureList.Count != loop.GetComponent<GameLoop>().player1.GetComponent<PlayerScript>().recruitmentController.GetComponent<RecruitmentScript>().recruitmentBacklog.Count)
        {
