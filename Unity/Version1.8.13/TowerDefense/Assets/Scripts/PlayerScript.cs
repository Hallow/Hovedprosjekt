...
public class PlayerScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (isAi)
        startPos.transform.position = new Vector3(startPos.transform.position.x, startPos.transform.position.y + 10f, startPos.transform.position.z - 3f);
