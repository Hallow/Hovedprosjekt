            ...
            case 0:
                switch (level)
                {
                    case 1:
                        ...
                        if (!go.GetComponent<TowerScript>().loop.GetComponent<GameLoop>().deIncrementCash(go.GetComponent<TowerScript>().playerOwner, go.GetComponent<TowerScript>().price))
                        {
                        ...
                        {
                            int i = currentTower.GetComponent<TowerScript>().playerOwner.GetComponent<PlayerScript>().towerList.IndexOf(currentTower);
                            currentTower.GetComponent<TowerScript>().playerOwner.GetComponent<PlayerScript>().towerList[i] = go;
                        }
                        return go;
                    case 2:
            ...
            case 1:
                switch (level)
                {
                    ...
                    case 4:
                        ...
                        return go;
                    case 5:
                        go = (GameObject)Instantiate(type1Prefabs[4]);
                        go.GetComponent<TowerScript>().Initialize(currentTower, maxUpgraded, level);
                        if (!go.GetComponent<TowerScript>().loop.GetComponent<GameLoop>().deIncrementCash(go.GetComponent<TowerScript>().playerOwner, go.GetComponent<TowerScript>().price))
                        {
                            //If this block triggers, the player has insufficient funds to purchase this tower.
            ...
            case 3:
                switch (level)
                {
                    case 1: //Town Hall
                        ...
                        if (!go.GetComponent<BuildingScript>().loop.GetComponent<GameLoop>().deIncrementCash(go.GetComponent<BuildingScript>().playerOwner, go.GetComponent<BuildingScript>().price))
                        {
                        ...
                        {
                            int i = currentTower.GetComponent<BuildingScript>().playerOwner.GetComponent<PlayerScript>().buildingList.IndexOf(currentTower);
                            currentTower.GetComponent<BuildingScript>().playerOwner.GetComponent<PlayerScript>().buildingList[i] = go;
                        }
                        return go;
                    case 2: //Barracks
