...
public class AiScript : MonoBehaviour {
    ...
    int id; //Player has equivalent
    public int cash; //Player has equivalent
    public int income; //Player has equivalent

    public GameObject unitFactory; //Player has equivalent
    public GameObject factoryPrefab; //Player has equivalent

    public List<GameObject> unitList; //Player has equivalent
    public List<GameObject> towerList; //Added to Player, in AI section

    public GameObject aiStart; //Player has equivalent

    public GameObject towerFactoryPrefab; //Added to Player, in AI section
    public GameObject towerFactory; //Added to Player, in AI section
