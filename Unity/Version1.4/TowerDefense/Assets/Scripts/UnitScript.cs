...
public class UnitScript : MonoBehaviour {
	...
	void Start () {
		...
		IsAlive = true;
        radius = gameObject.GetComponent<RadiusScript>();
	}
    ...
    public void Initialize(int health, float speed, float damage, int type, GameObject turnC, int owner, float attackSpeed)
    {
		this.Health = health;
		this.Speed = speed;
		this.Damage = damage;
        ...
        gameObject.GetComponent<Waypoint2Script>().turnController = turnC;
	}
