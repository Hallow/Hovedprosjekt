...
public class TowerFactory : MonoBehaviour {
	...
	{
        //TODO: towerPos, type, level, loop, and owner can be retrieved from currentTower, saving space
		...
		case 2:
			switch(level)
			{
				...
				case 5:
                    ...
                    go.GetComponent<TowerScript>().loop = currentTower.GetComponent<TowerScript>().loop;
